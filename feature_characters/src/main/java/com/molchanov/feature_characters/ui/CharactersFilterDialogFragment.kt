...
class CharactersFilterDialogFragment : BottomSheetDialogFragment() {
    ...
    private fun setActiveChipColor(chipList: List<Chip>, active: Chip) {
        ...
        chipList.forEach {
            it.setChipBackgroundColorResource(com.molchanov.coreui.R.color.yellow_dark)
        }

        active.setChipBackgroundColorResource(com.molchanov.coreui.R.color.yellow_bright)
